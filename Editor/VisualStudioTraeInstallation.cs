...
namespace Microsoft.Unity.VisualStudio.Editor
{
	internal class VisualStudioTraeInstallation : VisualStudioInstallation
	{
		...
		private static readonly string[] DesktopFilenames = new[] { "trae.desktop", "Trae.desktop", "code.desktop" };
...
";
		...
		private Process FindRunningTraeWithSolution(string solutionPath)
		{
			...
			foreach (var process in processes)
			{
				try
				{
					var workspaces = ProcessRunner.GetProcessWorkspaces(process, new[] { "trae", "Trae" }, "Trae");
